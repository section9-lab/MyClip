...
final class MemoryLintTests: XCTestCase {
    ...
    func testHandoffCarriesLintFindingsWithinBudget() throws {
        ...
        let handoff = HandoffPrompt.make(job: job, captures: [], changedPaths: ["Wiki/Projects/MyClip.md"], deletedCount: 0, completedAt: Date(), lint: report)
        ...
        let urgent = HandoffPrompt.make(job: job, captures: [], changedPaths: [], deletedCount: 0, completedAt: Date(), lint: nearCap,
        ...
        let bounded = HandoffPrompt.make(job: job, captures: [], changedPaths: [], deletedCount: 0, completedAt: Date(), lint: huge)
